...
export function Room(props) {
  const matcapTextture= useTexture('./image/Texture/mat1.png');
  const { nodes, materials } = useGLTF('/models/optimized-room.glb');
  const customMaterial = useMemo(() => {
    cloneCustomMaterial =new THREE.MeshPhongMaterial({color:'#d90429'});
    return cloneCustomMaterial;
  })

  return (
    <group {...props} dispose={null}>
       <mesh geometry={nodes.body1_blinn1_0.geometry} material={customMaterial} />
